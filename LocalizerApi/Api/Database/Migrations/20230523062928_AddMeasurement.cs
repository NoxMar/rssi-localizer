        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceUid = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    Rssi = table.Column<int>(type: "integer", nullable: false),
                    CapturedById = table.Column<string>(type: "character varying(24)", nullable: false),
